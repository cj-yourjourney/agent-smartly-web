          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
              <div className="flex flex-col gap-4 lg:order-1">
                ...
                <p className="text-base-content/65 text-lg leading-relaxed">
                  ...
                  — the real terms, rules, and definitions the DRE actually
                  tests. Nothing more. Study one subject at a time (e.g., Agency
                  Laws) with definitions, memory tricks, and AI explanations
                  built in.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
              <div className="lg:order-2 flex flex-col gap-4">
                ...
                <p className="text-base-content/65 text-lg leading-relaxed">
                  ...
                  . Every answer comes with a full explanation and memory tip —
                  so you learn why, not just what. Aim for 70%+ before moving
                  on.
                </p>
                <div className="flex flex-wrap gap-2">
                  {[
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
              <div className="flex flex-col gap-4 lg:order-1">
                ...
                <p className="text-base-content/65 text-lg leading-relaxed">
                  ...
                  concepts reviewed — all weighted to match the real DRE exam.
                  See which topic to focus on next and know when you're actually
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="rounded-2xl bg-base-200 border border-base-300 px-8 py-7 flex items-center gap-5">
                <div className="text-5xl font-bold text-primary shrink-0">
                  ×7
                </div>
              ...
              <div className="rounded-2xl border border-base-300 bg-base-100 px-7 py-6 flex gap-4 items-start">
                ...
                <div className="flex flex-col gap-1">
                  <p className="text-base-content/80 text-sm leading-relaxed italic">
                    ...
                    take a practice test in Contracts. I instantly see if I
                    really understand them. Then repeat for all topics."
                  </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <div className="flex flex-col gap-5 text-center lg:text-left items-center lg:items-start">
                ...
                <p className="text-base-content/60 leading-relaxed text-sm sm:text-base max-w-md">
                  ...
                  was genuinely human, I pivoted to real estate. Every prep tool
                  I tried let me down, so I built my own from scratch using the
            ...
            {isAuthenticated ? (
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-primary-content/50 text-xs font-medium">
                  60 questions free · then from {PLANS[0].price} · no
                  auto-renewal
                </p>
              </div>
            )}
